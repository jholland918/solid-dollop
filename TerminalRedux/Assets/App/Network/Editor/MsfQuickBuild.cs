...
namespace Assets.App.Network.Editor
{
    /// <summary>
    ...
    public class MsfQuickBuild
    {
        ...
        /// </summary>
        public static string QuickSetupRoot = "Assets/App/Network";
        ...
        [MenuItem("Tools/AppMsf/Build All", false, 0)]
        ...
        [MenuItem("Tools/AppMsf/Build Master + Spawner", false, 11)]
        ...
        [MenuItem("Tools/AppMsf/Build Client", false, 11)]
        ...
        [MenuItem("Tools/AppMsf/Build Game Server", false, 11)]
